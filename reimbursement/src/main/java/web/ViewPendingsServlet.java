...
public class ViewPendingsServlet extends HttpServlet {
    private ConnectionManager connectionManager;
    private ManagerService managerService;
    private ObjectMapper om;
    private static final Logger logger = LogManager.getLogger(ViewPendingsServlet.class.getName());
    @Override
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(userSession.getAttribute("currentId") != null) {
            ...
            requests = managerService.getAllPending();
